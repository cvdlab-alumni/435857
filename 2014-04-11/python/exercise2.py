...
# Modello 3D delle facciate esterne della struttura
# Qui mostro le facciate leterali e l'ingresso

vertical_enclosures = STRUCT([paretipianoterra,paretiprimopiano,paretisecondopiano,scalepianoterra,COLOR([0.3,0.5,0.8])(frontalecentro)])
vertical_enclosures = T([2])([13.8])(vertical_enclosures)
VIEW(STRUCT([vertical_enclosures,COLOR([0.9,0.95,0.3])(scala3)]))
